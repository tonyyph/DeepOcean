export const en = {
  ...
  onboarding: {
    ...
    welcomeBody:
      "Turn your focus into a calm dive, then let the app shape the first plan around what you actually want to improve.",
    goalEyebrow: "STEP 1 · GOALS",
    goalTitle: "What are you diving toward?",
    goalBody:
      "Choose at least one goal. Pick up to six so your plan stays focused.",
    goalValidation: "Choose at least one goal to continue.",
    goalOptions: {
      improve_focus: "Improve focus",
      build_consistency: "Build consistency",
      reduce_stress: "Reduce stress",
      learn_better: "Learn better",
    ...
    planBody:
      "DeepOcean turns those goals into a short focus plan. If AI is unavailable, a local rule-based guide keeps moving.",
    recommendationReason: "WHY THIS PLAN",
    recommendationFallback:
      "Offline fallback is active. Your plan is still saved and ready.",
    retryRecommendation: "TRY AGAIN",
    workflowEyebrow: "STEP 3 · WORKFLOW",
    workflowTitle: "Choose your starting rhythm",
    workflowBody:
      "This becomes your remembered workflow. You can change it later from Profile.",
    workflowOptions: {
      daily_focus: {
  ...
  notifications: {
    ...
    reminderChannel: "Dive reminders",
    completionChannel: "Dive completion",
    activeDiveChannel: "Active dive",
    ...
    center: {
      title: "Notifications",
      openAccessibility: "Open notifications",
      ...
      allReviewed: "All signals reviewed",
      fallbackLatest: "Dive reminders and session updates collect here.",
      total: "Total",
      unread: "Unread",
      latest: "Latest",
      all: "All",
      emptyAllTitle: "All quiet below the surface",
      emptyAllBody: "New reminders and dive updates will appear here.",
      emptyUnreadTitle: "Everything is caught up",
      emptyUnreadBody: "No unread signals are waiting for you.",
      typeComplete: "Complete",
      typeWarning: "Warning",
      typeActionNeeded: "Action needed",
