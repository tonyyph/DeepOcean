...
function makeTheme(spec: PrismaticSpec): AppTheme {
  return {
    ...
    colors: {
      ...
      panel: alpha(spec.surface, 0.26),
      panelStrong: alpha(spec.elevated, 0.42),
      panelTint: alpha(spec.accent, 0.06),
      panelEdge: alpha(spec.accent, 0.36),
      border: alpha(spec.accentSoft, 0.18),
      borderStrong: alpha(spec.accent, 0.42),
      text: spec.text,
      textSecondary: alpha(spec.text, 0.9),
      textMuted: alpha(spec.text, 0.76),
